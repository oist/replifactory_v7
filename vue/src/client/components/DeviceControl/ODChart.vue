...
export default {
  ...
  computed: {
    ...
    currentOD() {
      return {
        od: this.ods?.states[this.partId],
        signal: this.ods?.odsignals[this.partId],
      };
    },
    chartData() {
      if (
        this.calibrationData &&
        typeof this.calibrationData === "object" &&
        this.calibrationCoefs
      ) {
        const dataPoints = Object.entries(this.calibrationData)
