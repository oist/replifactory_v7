<template>
    <CCard style="width: 11rem" class="m-2">
        <CCardBody>
            ...
            <VialControl :odSensorId="odSensor.id" :disabled="disabled" class="my-2 mx-0" height="100px"/>
            ...
            <Stirrer :deviceId="stirrer.id" :key="stirrer.id" :title="stirrer.title" :disabled="disabled" />
        </CCardBody>
    </CCard>
</template>
    ...
    computed: {
        reactor() {
            return {
                ...
                subtitle: this.subtitle != null ? this.subtitle : `Lactobacillus plantarum`,
            }
        },
        valve() {
            return {
