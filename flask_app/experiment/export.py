...
def export_culture_plot_html(culture, output_directory):
    ...
    output_file = os.path.join(
        output_directory, experiment_name, "vial_%d_plot.html" % int(vial)
    )
...
def export_culture_csv(culture, output_directory):
    ...
    )  # Default value is a list of four None values
    ...
    output_file = os.path.join(
        output_directory, experiment_name, "vial_%d_data.csv" % int(vial)
    )
    output_file = os.path.abspath(output_file)
