...
class Events:
    ...
    EXPERIMENT_CANCELLING = "ExperimentCancelling"
    EXPERIMENT_CANCELLED = "ExperimentCancelled"
    EXPERIMENT_PAUSED = "ExperimentPaused"
    EXPERIMENT_RESUMED = "ExperimentResumed"
    # EXPERIMENT_UPDATED = "ExperimentUpdated"
    EXPERIMENT_NEW_CYCLE = "ExperimentNewCycle"
    EXPERIMENT_CYCLE_COMPLETE = "ExperimentCycleComplete"
    EXPERIMENT_CYCLE_TOO_LONG_WARNING = "ExperimentCycleTooLongWarning"
    ERROR = "Error"
