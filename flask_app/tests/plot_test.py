...
df = pd.read_csv(
    r"C:\Users\crusnac\Dropbox\IST\replifactory_v5\data\Cobalt_300922\vial_1\od.csv"
)
dosedf = pd.read_csv(
    r"C:\Users\crusnac\Dropbox\IST\replifactory_v5\data\Cobalt_300922\vial_1\medium2_concentration.csv"
)
gendf = pd.read_csv(
    r"C:\Users\crusnac\Dropbox\IST\replifactory_v5\data\Cobalt_300922\vial_1\log2_dilution_coefficient.csv"
)
print(df.od[0])
# %%
...
for i in range(dosedf.shape[0]):
    ...
    c._log_testing_generation(
        generation=gendf.log2_dilution_coefficient[i],
...
import flask_app.experiment.plot

# %%
importlib.reload(experiment)
importlib.reload(experiment.plot)
from flask_app.experiment.plot import plot_culture
