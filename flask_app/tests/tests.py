...
from flask_app.experiment.models import Culture, ExperimentModel
...
class ModelTestCase(unittest.TestCase):
    ...
    def test_create_experiment(self):
        experiment_id = self.create_model(
            ExperimentModel,
            name="Exp22",
        ...
        self.assertEqual(
            experiment.parameters, {"stock1_volume": 2000, "stock2_volume": 1000}
        )
