...
from replifactory.server.socketio import MachineNamespace
...
logging.getLogger("replifactory.drivers").setLevel(logging.INFO)
logging.getLogger("replifactory.events").setLevel(logging.INFO)
logging.getLogger("replifactory.devices").setLevel(logging.INFO)
