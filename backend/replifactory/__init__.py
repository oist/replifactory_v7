...
try:
    ...
    __version__ = pkg_resources.get_distribution("replifactory").version
...
def main():
    ...
    from replifactory.app import main

    main(args=args, prog_name="replifactory", auto_envvar_prefix="REPLIFACTORY")
