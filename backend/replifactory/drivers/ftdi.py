...
from replifactory.drivers.at24c256c import AT24C256C_Driver
from replifactory.drivers.ft2232h import I2cController, I2cPort
...
class Ftdi(_Ftdi):
    ...
    def read_eeprom(
        self, addr: int = 0, length: int | None = None, eeprom_size: int | None = None
    ) -> bytes:
    ...
    def _write_eeprom_raw(
        self, addr: int, data: Union[bytes, bytearray], dry_run: bool = True
    ) -> None:
