...
from flask_app.replifactory.util.flask import get_json_command_from_request
...
def test_get_json_command_from_request():
    ...
    with app.test_request_context('/endpoint', json=request_data) as context:
        command, data, response = get_json_command_from_request(context.request, valid_commands)
